    ...
    <Layout>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            {/* Info */}
            <div>
                <span className="bg-primary/20 text-primary px-3 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-4 inline-block">
                    {product.category}
                </span>
                ...
                <div className="text-4xl font-bold text-primary mb-8 font-serif">
                    R{product.price.toFixed(2)}
                </div>

                <p className="text-zinc-300 text-lg leading-relaxed mb-8 border-b border-zinc-800 pb-8">
                    {product.description}
                </p>
                ...
                <div className="flex items-center gap-6 mb-8">
                    ...
                    <button 
                        ...
                        className="flex-1 bg-gradient-to-br from-primary to-orange-400 text-black py-3 px-8 rounded font-bold text-lg hover:scale-105 transition-transform shadow-[0_0_20px_rgba(255,215,0,0.3)]"
                    >
                        Add to Cart
                    </button>
                </div>
