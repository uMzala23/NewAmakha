...
export default function Home() {
  const featuredProducts = products; // Show all for now as featured
    ...
    <Layout>
      ...
      <section className="bg-gradient-to-br from-zinc-900 to-black border-2 border-primary rounded-xl p-10 md:p-16 text-center mb-12 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
            <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 text-primary tracking-wide drop-shadow-md">
            Welcome to Amakha
            </h1>
            <p className="text-xl md:text-2xl text-zinc-300 mb-8 max-w-3xl mx-auto font-light leading-relaxed">
            Premium Car Perfumes, Luxury Colognes & Exclusive Branded Apparel
            </p>
